...
<div class="card">
  ...
  <div class="form-group">
    ...
    <textarea name="DescEngine" class="form-control" value="" id="exampleInputDescEngine" cols="30" rows="10"><?php echo  $productCarDetail->productCarDetailTextEngine ?></textarea>
  ...
  <div class="form-group">
    ...
    <textarea name="DescInterio" class="form-control" value="" id="exampleInputDescInterio"  cols="30" rows="10"><?php echo  $productCarDetail->productCarDetailTextInterio?></textarea>
  ...
  <div class="form-group">
    ...
    <textarea name="DescTechniques" class="form-control" value="" id="exampleInputDescTechniques"  cols="30" rows="10"><?php echo  $productCarDetail->productCarDetailTextTechniques?></textarea>
