...
class ProductDetailController extends CI_Controller
{
	...
	//tìm kiếm 
	public function searchProductDetail()
	{

		if (isset($_GET['keyword']) && $_GET['keyword'] != '') {
			$keywordProductDetail = $_GET['keyword'];
		}
		$this->load->model('ProductDetailModel');
		$this->data['productDetail'] = $this->ProductDetailModel->getProductByKeyWord($keywordProductDetail); //load data
		$this->load->view('TemplateAD/header');
		$this->load->view('TemplateAD/navbar');
		$this->load->view('productCarDetailAD/searchProductDetail', $this->data);
		$this->load->view('TemplateAD/footer');
	}
}
