  ...
  <div class="card-body">
    ...
    <form action="<?php echo base_url('AutoMaker/update/' . $autoMaker->autoMakerID) ?>" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="text" name="autoMakerName" value="<?php echo $autoMaker->autoMakerName ?>" class="form-control" id="slug" onkeyup="ChangeToSlug();">
      ...
      <div class="form-group">
        ...
        <input type="text" name="autoMakerSlug" value="<?php echo $autoMaker->slug ?>" class="form-control" id="convert_slug">
