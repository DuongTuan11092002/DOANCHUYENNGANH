...
<div class="card">
  ...
  <div class="">
          ...
          <hr> 
                ...
                ?> 
        <form action="<?php echo base_url('NewDetail/formCreateNewDetail')?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <textarea name="newDetailDesc" class="form-control" id="exampleInputNewDetailDesc" placeholder="Nhập mô tả tin tức giới hạn 200 kí tự" id="" cols="30" rows="10"></textarea>
         
          <?php echo '<span class="text text-danger">'. form_error('newDesc') .'</span>'; ?>
        </div>   
        <div class="form-group">
          <label for="exampleInputNewDetailTime">Ngày Tạo</label>
          <input type="date" name="newDetailTime" class="form-control" id="exampleInputNewDetailTime" >
