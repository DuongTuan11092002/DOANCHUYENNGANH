        ...
        <div class="row gy-4 gy-md-5 gy-lg-0 align-items-md-center">
            ...
            <div class="col-12 col-lg-6">
                <div class="border overflow-hidden">
                    ...
                    <form action="<?php echo base_url('gui-lien-he') ?>" method="POST">
                        <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                            ...
                            <div class="col-12 mt-4">
                                <label for="message" class="form-label">Ghi chú <span class="text-danger">*</span></label>
                ...
                <div class="row justify-content-xl-center">
                    <div class="col-12 col-xl-11">
                        <div class="mb-4 mb-md-5">
                            ...
                            <div>
                                <h4 class="mb-2">Cửa hàng</h4>
                                <hr class="w-50 mb-3 border-dark-subtle">
                                <address class="m-0 text-secondary">Khóm 1 , Thị trấn châu thành , Trà Vinh</address>
                            </div>
                        </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="mb-4 mb-sm-0">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0">
                                            <a class="link-secondary text-decoration-none" href="tel:+0364202648"> (+84) 364202648</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="mb-4 mb-sm-0">
                                    ...
                                    <div>
                                        ...
                                        <hr class="w-75 mb-3 border-dark-subtle">
                                        <p class="mb-0">
                                            <a class="link-secondary text-decoration-none" href="mailto:Kim884740@gmail.com">Kim884740@gmail.com</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div>
                                <h4 class="mb-2">Thời gian làm việc</h4>
                                <hr class="w-50 mb-3 border-dark-subtle">
                                <div class="d-flex mb-1">
                                    <p class="text-secondary fw-bold mb-0 me-5 pr-2">Thứ 2 - Thứ 7:</p>
                                    <p class="text-secondary mb-0">8AM - 8PM</p>
                                </div>
                                <div class="d-flex">
                                    <p class="text-secondary fw-bold mb-0 me-5 pr-2">Chủ nhật:</p>
